...
ZIPGUI <- function(data, prior.lambda=c(0, 100), prior.pi=c(1, 1),
  ...
  onRun <- function(...){
    ...
    if(exists("imgPlot4", where=envirZIP)){
      imgPlot4 <- get("imgPlot4", envir=envirZIP)
      tkpack.forget(imgPlot4)
    }
    
    imgPlot1 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results, plotnumber=1), hscale=1.3,vscale=1.4)
    imgPlot2 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=2), hscale=1.3,vscale=1.4)
    imgPlot3 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=3), hscale=1.3,vscale=1.4)
    imgPlot4 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results, plotnumber=4), hscale=1.3,vscale=1.4)
    ...
    assign("imgPlot4", value = imgPlot4, envir = envirZIP)
  ...
  onNextplot <- function(...){
    ...
    if(plotNumber==1){
      ...
      imgPlot3 <- get("imgPlot3", envir=envirZIP)
      tkpack.forget(imgPlot3)
      assign("plotNumber",value=4,envir=envirZIP)
      imgPlot4 <- get("imgPlot4", envir=envirZIP)
      tkpack(imgPlot4, side="top")
...
PEMGUI <- function(x=20, n=20, k=1, prior.pi=c(1,1), prior.se=c(1,1),
  ...
  onRun <- function(...){
    ...
    if(exists("imgPlot4", where=envirPEM)){
      imgPlot4 <- get("imgPlot4", envir=envirPEM)
      tkpack.forget(imgPlot4)
    }
    
    imgPlot1 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=1),hscale=1.6,vscale=1.5)
    imgPlot2 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=2),hscale=1.5,vscale=1.6)
    imgPlot3 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=3),hscale=1.5,vscale=1.6)
    imgPlot4 <- tkrplot(imgFrame,fun=function() plotDiag(mod@results,plotnumber=4),hscale=1.5,vscale=1.6)
    ...
    assign("imgPlot4", value=imgPlot4, envir=envirPEM)
  ...
  onNextplot <- function(...){
    ...
    if(plotNumber==1){
      ...
      imgPlot3 <- get("imgPlot3", envir=envirPEM)
      tkpack.forget(imgPlot3)
      assign("plotNumber",value=4,envir=envirPEM)
      imgPlot4 <- get("imgPlot4", envir=envirPEM)
      tkpack(imgPlot4, side="top")
    } else if(plotNumber==4){       
      imgPlot4 <- get("imgPlot4", envir=envirPEM)
