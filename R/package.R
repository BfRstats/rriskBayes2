...
#' fitting Bayesian models using the package \pkg{BRugs}. This package does not
...
#' Alexander Engelhardt \email{engelhardt@@stat-up.de} (\acronym{STAT-UP} Statistical Consulting, Germany)
#' @note See also the documentation to the \acronym{R}-package \pkg{\link{BRugs}}.
#' @keywords package
#' @examples
#' \donttest{
#' #------------------------------------------
